...
class GetHandoversListModel {
  ...
  factory GetHandoversListModel.fromJson(Map<String, dynamic> json) => GetHandoversListModel(
        ...
        data: json["data"] == null
            ? []
            : List<SMHandoversDatum>.from(json["data"]!.map((x) => SMHandoversDatum.fromJson(x))),
      );
...
class SMHandoversDatum {
  ...
  factory SMHandoversDatum.fromJson(Map<String, dynamic> json) => SMHandoversDatum(
